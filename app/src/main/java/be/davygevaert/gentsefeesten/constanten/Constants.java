...
public class Constants {
    ...
    public static final String GENTSE_FEESTEN_DATA =            "gentsefeestendata.json";
    ...
    public static final String URL_BEZETTING_PARKINGS_REALTIME = "http://datatank.stad.gent/4/mobiliteit/bezettingparkingsrealtime.json";
